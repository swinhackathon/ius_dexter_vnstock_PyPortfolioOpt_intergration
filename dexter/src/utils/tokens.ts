 ...
 * Anthropic's default is 3, but we use 10 for deep multi-company analysis.
 * Supports comparing 2 companies with 5 tools each (financials, balance sheet, income statement, price, history).
 */
export const KEEP_TOOL_USES = 10;
